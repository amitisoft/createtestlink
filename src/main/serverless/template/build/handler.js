...
/***/ (function(module, exports, __webpack_require__) {
	...
	"use strict";
	var candidate_facade_1 = __webpack_require__(1);
	var candidate_service_1 = __webpack_require__(2);
	var find_candidateemail_handler_1 = __webpack_require__(351);
	var booking_facade_1 = __webpack_require__(352);
	var booking_service_1 = __webpack_require__(353);
	var AppContext = (function () {
	    function AppContext() {
	        this.endPoint = process.env.CANDIDATE_ALL_END_POINT;
	    }
	    AppContext.prototype.candidateService = function () {
	        return new candidate_service_1.CandidateServiceImpl();
	    };
	    AppContext.prototype.candidateFacade = function () {
	        return new candidate_facade_1.CandidateFacade(this.candidateService());
	    };
	    AppContext.prototype.bookingService = function () {
	        return new booking_service_1.BookingServiceImpl();
	    };
	    AppContext.prototype.bookingFacade = function () {
	        return new booking_facade_1.BookingFacade(this.bookingService());
	    };
	    return AppContext;
	}());
	...
	exports.findEmailHandler = new find_candidateemail_handler_1.FindCandidateEmailHandler(appContext.candidateFacade()).handler;
...
/***/ (function(module, exports) {
	...
	var CandidateFacade = (function () {
	    ...
	    CandidateFacade.prototype.createCandidate = function (data) {
	        //validate data as per business logic
	        return this.candidateService.create(data);
	    };
	    CandidateFacade.prototype.updateCandidate = function (data) {
	        return this.candidateService.update(data);
	    };
	    CandidateFacade.prototype.findByEmail = function (email) {
	        return this.candidateService.findByEmail(email);
	    };
	    CandidateFacade.prototype.findCandidate = function (candidateId) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var CandidateServiceImpl = (function () {
	    ...
	    CandidateServiceImpl.prototype.create = function (data) {
	    ...
	    CandidateServiceImpl.prototype.update = function (data) {
	    ...
	    CandidateServiceImpl.prototype.find = function (candidateId) {
	    ...
	    CandidateServiceImpl.prototype.findByEmail = function (email) {
	        var _this = this;
	        ...
	        return rxjs_1.Observable.create(function (observer) {
	            ...
	            documentClient.query(queryParams, function (err, data) {
	                ...
	                _this.findByCategory(data.Items[0].candidateId, email); // Based on candidateId fetch the DOE,Category
	    ...
	    CandidateServiceImpl.prototype.getCandidateBookingInfo = function (candidateId) {
	    ...
	    CandidateServiceImpl.prototype.findByCategory = function (candidateId, email) {
	        var _this = this;
	        ...
	        documentClient.query(queryParams, function (err, data) {
	            ...
	            if (data.Items.length === 1) {
	                ...
	                var token_1 = _this.randomnumber();
	                console.log(token_1);
	                _this.sendEmail(email, token_1);
	                _this.updateBookingInfo(candidateId, "java", "26-04-2017", "JavaDeveloper");
	                _this.updateCandidateInfo(candidateId, token_1);
	            }
	            //console.log("Booking Category",data.Items[0].category);
	            //console.log("Attended DateofExam",data.Items[0].dateofExam);
	            var cate = data.Items[0].category;
	            var doe = data.Items[0].dateofExam;
	            var token = _this.randomnumber();
	            console.log(token);
	            switch (cate) {
	                case 'java' || 'Java' || 'JAVA':
	                    var diffdays = _this.diffDays();
	                    if (diffdays > 30) {
	                        _this.sendEmail(email, token);
	                        _this.updateCandidateInfo(candidateId, token);
	                    }
	                    else {
	    ...
	    CandidateServiceImpl.prototype.randomnumber = function () {
	        return Math.random().toString(36).substr(2); // remove `0.
	    };
	    CandidateServiceImpl.prototype.diffDays = function () {
	    ...
	    CandidateServiceImpl.prototype.sendEmail = function (email, messageBody) {
	        var _this = this;
	        var emailConfig = {
	            region: 'us-east-1'
	        };
	        ...
	        var p = new Promise(function (res, rej) {
	            ...
	            var emailParams = _this.createEmailParamConfig(email, messageBody);
	    ...
	    CandidateServiceImpl.prototype.createEmailParamConfig = function (email, message) {
	        var params = {
	            Destination: {
	                BccAddresses: [],
	                CcAddresses: [],
	    ...
	    CandidateServiceImpl.prototype.generateEmailTemplate = function (emailFrom, message) {
	    ...
	    CandidateServiceImpl.prototype.updateCandidateInfo = function (candidateId, token) {
	    ...
	    CandidateServiceImpl.prototype.updateBookingInfo = function (candidateId, cate, doe, jobPos) {
...
/***/ (function(module, exports) {
	...
	"use strict";
	var FindCandidateEmailHandler = (function () {
	    function FindCandidateEmailHandler(facade) {
	        var _this = this;
	        this.facade = facade;
	        this.handler = function (event, context, callback) {
	            ...
	            var emails = "monica@amitisoft.com";
	            //event.pathParameters.email || "abc";
	            _this.facade.findByEmail(emails).subscribe(function (result) {
	                var response = {
	                    statusCode: 200,
	                    body: result
	                };
	    ...
	    return FindCandidateEmailHandler;
	}());
	exports.FindCandidateEmailHandler = FindCandidateEmailHandler;
...
/***/ (function(module, exports) {
	...
	var BookingFacade = (function () {
	    ...
	    //      return this.candidateService.create(data);
	    //  }
	    BookingFacade.prototype.updateBookingCandidate = function (data) {
	        return this.bookingService.update(data);
	    };
	    BookingFacade.prototype.getBookingDetails = function () {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var BookingServiceImpl = (function () {
	    ...
	    BookingServiceImpl.prototype.find = function (candidateId) {
	        var _this = this;
	    ...
	    //         });
	    //     });
	    BookingServiceImpl.prototype.getBookingDetails = function () {
